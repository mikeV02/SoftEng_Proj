...
<?php
	...
	mysql_query("INSERT INTO `softeng`.`users` (`ID`, `user_login`, `user_pass`, `user_email`, `user_registered`, `user_status`, `display_name`) VALUES(2, $user_nam, $passreg, $uemail, NULL, NULL, NULL)");
	
				//mysql_query("INSERT INTO users VALUES(2, $user_nam, $passreg, $uemail, NULL, NULL, NULL)");
