...
<?php
	...
	if($db_found){
		...
		//	if($passreg == $passcheck){
				...
				mysql_query("INSERT INTO users (ID, user_login, user_pass, user_email, user_registered, user_status, display_name) VALUES(2, '$user_nam', '$passreg', '$uemail', NULL, NULL, NULL)");
